...
deposit money, withdraw money, and display the account balance. Ensure that theaccount balance 
...
class BankAccount:
  ...
  def display_balance(self):
    print("account balance for {} (amount #{}):₹{}".format(self.__account_holder_name,self.__account_number,self.__account_balance))
